...
const ADJECTIVE_SUFFIXES: &[&str] = &[
    "able", "ible", "al", "ial", "ful", "ic", "ical", "ish", "ive", "ative", "less", "ous",
    "ious", "eous", "y", "ary", "ory", "ant", "ent", "en", "ed", "ing",
];

/// Common words the adjective suffix rule would otherwise claim.
#[rustfmt::skip]
const ADJECTIVE_STOPLIST: &[&str] = &[
    "the", "any", "many", "very", "every", "only", "early", "family", "city", "body", "study",
    "money", "story", "policy", "company", "country", "history", "memory", "theory",
    "industry", "energy", "quality", "society", "security", "activity", "may", "say", "way",
    "day", "boy", "key", "they", "why", "by", "my", "guy", "buy", "eye", "lie", "die", "tie",
    "thing", "king", "ring", "spring", "morning", "evening", "during", "nothing", "something",
    "anything", "everything", "being", "having", "doing", "going", "getting", "making",
    "taking",
];
...
const MINIMIZERS: &[&str] = &[
    "hardly", "barely", "scarcely", "rather", "somewhat", "slightly", "mildly", "fairly",
    "moderately", "reasonably", "tolerably", "passably", "quite",
];

/// Extreme-magnitude words a minimizer can be ironic about.
#[rustfmt::skip]
const EXTREMES: &[&str] = &[
    "big", "huge", "vast", "enormous", "immense", "infinite", "endless", "massive",
    "gigantic", "colossal", "tiny", "minute", "microscopic", "impossible", "certain",
    "perfect", "total", "complete", "absolute", "catastrophic", "disastrous", "unprecedented",
    "extraordinary", "incredible", "unbelievable", "terrifying", "devastating",
];
...
const COSMIC_NOUNS: &[&str] = &[
    "universe", "universes", "galaxy", "galaxies", "cosmos", "eternity", "infinity",
    "existence", "creation", "civilization", "civilizations", "history", "time", "space",
    "reality", "consciousness", "meaning", "purpose", "destiny", "fate", "soul", "souls",
    "species", "evolution", "extinction", "apocalypse", "millennia", "millennium", "epoch",
    "epochs", "eon", "eons", "aeon", "aeons", "lifetime", "lifetimes", "generation",
    "generations", "empire", "empires", "star", "stars", "planet", "planets", "world",
    "worlds", "dimension", "dimensions", "improbability", "probability", "chance",
    "coincidence", "happiness", "despair", "boredom", "misery", "bureaucracy", "paperwork",
...
const IMPERATIVE_VERBS: &[&str] = &[
    "get", "buy", "try", "start", "stop", "join", "call", "click", "visit", "download",
    "discover", "explore", "find", "learn", "see", "look", "read", "check", "book", "order",
    "shop", "save", "grab", "take", "make", "build", "create", "sign", "subscribe",
    "register", "contact", "ask", "request", "schedule", "claim", "unlock", "boost",
    "transform", "upgrade", "switch", "choose", "pick", "compare", "share", "follow", "watch",
    "listen", "imagine", "consider", "remember", "forget", "meet", "let", "give", "add",
    "keep", "put", "send", "bring", "come", "go", "do", "be", "have", "use", "enjoy",
    "experience", "act", "hurry",
];
